...
public class TimeslotRestController implements BaseRestController<Timeslot, Long> {
     ...
     */
    @PostMapping("/join")
    public ResponseEntity<Timeslot> joinAppointment(@RequestBody TimeslotRequestBody timeslotRequestBody,
                                                    BindingResult result) {
        ...
        try {
            ...
            log.info(String.format("FAIL: Student %s not found",
                    timeslotRequestBody.getMatriculationNumber()));
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        }
    }
     ...
     */
    @PostMapping("/leave")
    public ResponseEntity<Timeslot> leaveAppointment(@RequestBody TimeslotRequestBody timeslotRequestBody,
                                                     BindingResult result) {
     ...
     */
    @Override
    public ResponseEntity<Timeslot> update(@PathVariable Long id,
