...
public class TradeOfferService implements RestService<TradeOffer, Long> {
	 ...
	 * @param futureTimeslotId new {@link Timeslot} to assign to {@link de.hsrm.mi.swtp.exchangeplatform.model.data.Student}
	 ...
	 */
	public Timeslot adminTrade(long studentId, long ownedTimeslotId, long futureTimeslotId, long adminId) throws NotFoundException {
